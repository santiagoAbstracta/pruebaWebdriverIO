...
describe('utils', function () {
    describe('getAndCreatePath', function () {
        var folder = (0, path_1.join)(process.cwd(), '/.tmp/utils');
        afterEach(function () { return (0, fs_extra_1.removeSync)(folder); });
        it('should create the folder and return the folder name for a device that needs to have it\s own folder', function () {
            ...
            var expectedFolderName = (0, path_1.join)(folder, options.deviceName);
            expect((0, fs_extra_1.pathExistsSync)(expectedFolderName)).toMatchSnapshot();
            expect((0, utils_1.getAndCreatePath)(folder, options)).toEqual(expectedFolderName);
            expect((0, fs_extra_1.pathExistsSync)(expectedFolderName)).toMatchSnapshot();
        });
        it('should create the folder and return the folder name for a browser that needs to have it\s own folder', function () {
            ...
            var expectedFolderName = (0, path_1.join)(folder, "desktop_" + options.browserName);
            expect((0, fs_extra_1.pathExistsSync)(expectedFolderName)).toMatchSnapshot();
            expect((0, utils_1.getAndCreatePath)(folder, options)).toEqual(expectedFolderName);
            expect((0, fs_extra_1.pathExistsSync)(expectedFolderName)).toMatchSnapshot();
        });
        it('should create the folder and return the folder name for a browser', function () {
            ...
            expect((0, fs_extra_1.pathExistsSync)(folder)).toMatchSnapshot();
            expect((0, utils_1.getAndCreatePath)(folder, options)).toEqual(folder);
            expect((0, fs_extra_1.pathExistsSync)(folder)).toMatchSnapshot();
        });
    });
    describe('formatFileName', function () {
        ...
        it('should format a string with all options provided', function () {
            ...
            expect((0, utils_1.formatFileName)(formatFileOptions)).toMatchSnapshot();
        });
    ...
    describe('checkIsMobile', function () {
        it('should return false when no platform name is provided', function () {
            expect((0, utils_1.checkIsMobile)('')).toMatchSnapshot();
        });
        it('should return true when a platform name is provided', function () {
            expect((0, utils_1.checkIsMobile)('ios')).toMatchSnapshot();
        });
    });
    describe('checkIsAndroid', function () {
        it('should return false when no platform name is provided', function () {
            expect((0, utils_1.checkIsAndroid)('')).toMatchSnapshot();
        });
        it('should return false when a platform name is provided that is not accepted', function () {
            expect((0, utils_1.checkIsAndroid)('chrome')).toMatchSnapshot();
        });
        it('should return true when a valid platform name is provided', function () {
            expect((0, utils_1.checkIsAndroid)('androId')).toMatchSnapshot();
        });
    });
    describe('checkIsIos', function () {
        it('should return false when no platform name is provided', function () {
            expect((0, utils_1.checkIsIos)('')).toMatchSnapshot();
        });
        it('should return false when a platform name is provided that is not accepted', function () {
            expect((0, utils_1.checkIsIos)('chrome')).toMatchSnapshot();
        });
        it('should return true when a valid platform name is provided', function () {
            expect((0, utils_1.checkIsIos)('IoS')).toMatchSnapshot();
        });
    });
    describe('checkTestInBrowser', function () {
        it('should return false when no browser name is provided', function () {
            expect((0, utils_1.checkTestInBrowser)('')).toMatchSnapshot();
        });
        it('should return true when a browser name is provided', function () {
            expect((0, utils_1.checkTestInBrowser)('chrome')).toMatchSnapshot();
        });
    });
    describe('checkTestInMobileBrowser', function () {
        it('should return false when no platform name is provided', function () {
            expect((0, utils_1.checkTestInMobileBrowser)('', 'chrome')).toMatchSnapshot();
        });
        it('should return false when a plaform but no browser name is provided', function () {
            expect((0, utils_1.checkTestInMobileBrowser)('ios', '')).toMatchSnapshot();
        });
        it('should return true when a plaform and a browser name is provided', function () {
            expect((0, utils_1.checkTestInMobileBrowser)('ios', 'chrome')).toMatchSnapshot();
        });
    });
    describe('checkAndroidNativeWebScreenshot', function () {
        it('should return false when no platform name is provided', function () {
            expect((0, utils_1.checkAndroidNativeWebScreenshot)('', false)).toMatchSnapshot();
        });
        it('should return false when iOS and nativeWebscreenshot true is provided', function () {
            expect((0, utils_1.checkAndroidNativeWebScreenshot)('ios', true)).toMatchSnapshot();
        });
        it('should return false when iOS and nativeWebscreenshot false is provided', function () {
            expect((0, utils_1.checkAndroidNativeWebScreenshot)('ios', false)).toMatchSnapshot();
        });
        it('should return false when Android and nativeWebscreenshot false is provided', function () {
            expect((0, utils_1.checkAndroidNativeWebScreenshot)('Android', false)).toMatchSnapshot();
        });
        it('should return true when Android and nativeWebscreenshot true is provided ', function () {
            expect((0, utils_1.checkAndroidNativeWebScreenshot)('Android', true)).toMatchSnapshot();
        });
    });
    describe('checkAndroidChromeDriverScreenshot', function () {
        it('should return false when no platform name is provided', function () {
            expect((0, utils_1.checkAndroidChromeDriverScreenshot)('', false)).toMatchSnapshot();
        });
        it('should return false when iOS and nativeWebscreenshot true is provided', function () {
            expect((0, utils_1.checkAndroidChromeDriverScreenshot)('ios', true)).toMatchSnapshot();
        });
        it('should return false when iOS and nativeWebscreenshot false is provided', function () {
            expect((0, utils_1.checkAndroidChromeDriverScreenshot)('ios', false)).toMatchSnapshot();
        });
        it('should return false when Android and nativeWebscreenshot true is provided', function () {
            expect((0, utils_1.checkAndroidChromeDriverScreenshot)('Android', true)).toMatchSnapshot();
        });
        it('should return true when Android and nativeWebscreenshot false is provided ', function () {
            expect((0, utils_1.checkAndroidChromeDriverScreenshot)('Android', false)).toMatchSnapshot();
        });
    });
    describe('getAddressBarShadowPadding', function () {
        ...
        it('should return 0 when this is a check for a desktop browser', function () {
            ...
            expect((0, utils_1.getAddressBarShadowPadding)(getAddressBarShadowPaddingOptions)).toMatchSnapshot();
        });
    ...
    describe('getToolBarShadowPadding', function () {
        it('should return 0 when this is a check for a desktop browser', function () {
            ...
            expect((0, utils_1.getToolBarShadowPadding)(getToolBarShadowPaddingOptions)).toMatchSnapshot();
        });
        it('should return 0 when this is a check for an Android app', function () {
            var getToolBarShadowPaddingOptions = {
    ...
    describe('calculateDprData', function () {
        it('should multiple all number values by the dpr value', function () {
            ...
            expect((0, utils_1.calculateDprData)(data, 2)).toMatchSnapshot();
        });
    });
    describe('getScreenshotSize', function () {
        it('should get the screenshot size of a screenshot string with the default DPR', function () {
            expect((0, utils_1.getScreenshotSize)(mocks_1.IMAGE_STRING)).toMatchSnapshot();
        });
        it('should get the screenshot size of a screenshot string with DRP 2', function () {
            expect((0, utils_1.getScreenshotSize)(mocks_1.IMAGE_STRING, 2)).toMatchSnapshot();
        });
    });
});

...
var setCustomCss_1 = require("../clientSideScripts/setCustomCss");
var constants_1 = require("./constants");
var utils_1 = require("./utils");
var instanceData_1 = require("../methods/instanceData");
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    addressBarPadding = (0, utils_1.getAddressBarShadowPadding)({
                    ...
                    toolBarPadding = (0, utils_1.getToolBarShadowPadding)({ platformName: platformName, browserName: browserName, toolBarShadowPadding: toolBarShadowPadding, addShadowPadding: addShadowPadding });
                ...
                case 1:
                    ...
                    _b.label = 2;
                case 2:
                    if (!(hideElements.length > 0 || removeElements.length > 0)) return [3, 6];
                    _b.label = 3;
                case 3:
                    _b.trys.push([3, 5, , 6]);
                ...
                case 5:
                    ...
                    return [3, 6];
                case 6:
                    if (!(disableCSSAnimation || (0, utils_1.checkIsMobile)(platformName))) return [3, 8];
                ...
                case 8:
                    ...
                    return [2, (0, instanceData_1.default)(executor, instanceOptions, addShadowPadding)];
            }
        });
    });
}
